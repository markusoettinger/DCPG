...
contractaddress = '0xa630DAFdEac1610c89121dEe9EA13853d0E4BCAE'
...
class W3Library:
    ...
    def inCharging(self):
        ...
        processes = []
        log.info(
            f"Currently are {numberCharging} charging processes active. Contract Balance: {round(self.getBalance(contractaddress) * 1e-18, 3)} ether")
